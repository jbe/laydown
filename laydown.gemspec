...
Gem::Specification.new do |s|
  ...
  s.authors = ["jbe"]
  s.date = %q{2010-12-08}
  s.description = %q{Provides a simple Ruby DSL for defining HTML5 layouts for web apps. For those of us who has written basically the same html head 200 times and feels like stripping.}
